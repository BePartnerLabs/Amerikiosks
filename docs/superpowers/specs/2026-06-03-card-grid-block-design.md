...
- **Mobile:** heading stacks above cards; cards → 2 col → 1 col at narrow
...
- **Mobile:** cards → 2 col → 1 col; icon stays visible at all sizes
...
- **Heading:** large, dark, centered; subheading in muted color below
- **CTA button:** optional, centered below card row, outline style
- **Mobile:** cards → 2 col → 1 col; CTA button full-width below
...
- Per-card links use `data-ga-event="card_cta_click"` + `data-ga-section` inherited from block
...
## Open design tasks (before implementation)

- [ ] **Mobile mockups** — produce mockups for all 3 variants at 375px showing: heading collapse, card stacking, CTA button width, and icon sizing. Confirm with client before building responsive styles.
