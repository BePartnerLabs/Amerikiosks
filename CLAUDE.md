...
| [`docs/render-requirements.md`](docs/render-requirements.md) | What to ask the person who produces the machine renders. Written to be sent as-is to someone outside the team. |
