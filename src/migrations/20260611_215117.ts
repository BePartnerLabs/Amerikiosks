...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_locales" DROP COLUMN "hero_breadcrumb";
  ALTER TABLE "_pages_v_locales" DROP COLUMN "version_hero_breadcrumb";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_locales" ADD COLUMN "hero_breadcrumb" varchar;
  ALTER TABLE "_pages_v_locales" ADD COLUMN "version_hero_breadcrumb" varchar;
