...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "header_nav_items_mega_menu_items" ADD CONSTRAINT "header_nav_items_mega_menu_items_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "header_nav_items_mega_menu_items_icon_idx" ON "header_nav_items_mega_menu_items" USING btree ("icon_id");
